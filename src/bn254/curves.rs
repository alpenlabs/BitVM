...
impl G2Affine {
    ...
    pub fn hinted_endomorphism_affine(q: ark_bn254::G2Affine) -> (ark_bn254::G2Affine, Script, Vec<Hint>) {
    ...
    pub fn hinted_p_power_endomorphism(q: ark_bn254::G2Affine) -> (ark_bn254::G2Affine, Script, Vec<Hint>) {
...
mod test {
    ...
    #[test]
    fn test_hinted_p_power_endomorphism() {
        let mut prng = ChaCha20Rng::seed_from_u64(0);
        let q = ark_bn254::G2Affine::rand(&mut prng);
        let (qdash, scr_endo, hints) = G2Affine::hinted_p_power_endomorphism(q);
    ...
    #[test]
    fn test_hinted_endomorphism_affine() {
        let mut prng = ChaCha20Rng::seed_from_u64(0);
        let q = ark_bn254::G2Affine::rand(&mut prng);
        let (qdash, scr_endo, hints) = G2Affine::hinted_endomorphism_affine(q);
